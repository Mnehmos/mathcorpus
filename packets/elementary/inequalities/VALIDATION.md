...
```bash
python tools/stamp_hashes.py packets/elementary/inequalities/<name>.v<version>.json
python tools/validate_packets.py packets/elementary/inequalities/<name>.v<version>.json --check-hashes --warn-as-error
```
