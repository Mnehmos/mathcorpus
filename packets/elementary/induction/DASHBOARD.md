...
|--------|-------|
| Packets | 10+ |
| Level breakdown | L0_elementary: 1 · L1_proof_basics: 9+ |
...
the first attempt), and `sum_evens` (D1, L1, episode
`7c564d42-9a98-4780-9d1c-3affd65958d6`: `∑ i ∈ range n, (2*i+2) = n*(n+1)`,
kernel_verified on the first attempt). Other domain-agent instances are
committing to this folder concurrently — re-sync against
