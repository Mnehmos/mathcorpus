# Trace Policy — Erdős Frontier

All meaningful proof and research work for packets in this folder must go
through the tracked proof-search MCP loop, or be explicitly recorded in
`SOURCE_REVIEW.md` / `BLOCKERS.md` for non-proof-search work (attack
plans, source reviews, route pivots).
