...
This lane holds labeled, non-proof-bearing `negative_example` packets for Induction — failed/abandoned proof attempts preserved as training data (roadmap v0.1 release criteria calls for ≥25 negative examples corpus-wide).

This folder is both packet storage and a local agent workspace for Induction
(`negative`).
